...
export default function Home() {
    ...
    return (
        <div className="pb-10">
            ...
            <section>
                <h2 className="text-2xl font-bold mb-4 px-2">Highest Revenue</h2>
                <MovieSlider title="" movies={revenueMovies} type="banner" itemsPerPage={1} />
            </section>

            {/* Most Popular (15-30 items, 3 per page) */}
            <section className="mb-8">
                <MovieSlider title="Most Popular" movies={popularMovies} itemsPerPage={3} />
            </section>

            {/* Top Rated (15-30 items, 3 per page) */}
            <section className="mb-8">
                <MovieSlider title="Top Rated" movies={topRatedMovies} itemsPerPage={3} />
            </section>
        </div>
    );
}
