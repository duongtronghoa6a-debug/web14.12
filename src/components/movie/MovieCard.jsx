...
export default function MovieCard({ movie }) {
    ...
    return (
        <div className="group relative w-full rounded-lg overflow-hidden shadow-md bg-card transition-transform hover:scale-110 hover:shadow-xl duration-300 z-0 hover:z-10">
